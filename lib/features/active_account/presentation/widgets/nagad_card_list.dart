...
class Nagad_Card_List_Widget extends StatefulWidget {
  const Nagad_Card_List_Widget(
      {super.key,
      required this.name,
  ...
  @override
  State<Nagad_Card_List_Widget> createState() => _Nagad_Card_List_WidgetState();
}

class _Nagad_Card_List_WidgetState extends State<Nagad_Card_List_Widget> {
  @override
  void initState() {
    super.initState();
    if (widget.isactive) {
  ...
  final nagadStatusRef = FirebaseDatabase.instance.ref('/activeAccount/nagad');
